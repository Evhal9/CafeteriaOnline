    ...
    return (
        <footer className="footer">
            <div className="footer-container">
                ...
                <div className="footer-section">
                    ...
                    <div className="social-icons">
                        ...
                        <a href="https://wa.me/5491112345678" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="footer-bottom">
                <p>&copy; {new Date().getFullYear()} Cafetería Luna & Granos Café. Todos los derechos reservados.</p>
            </div>
        </footer>
    );
}
